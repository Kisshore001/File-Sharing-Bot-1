...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "7355070043:AAGsrMr3SpGrdTTt3Fy-qmbBPseWOdbADL0")
API_ID = int(os.environ.get("API_ID", "20293219"))
...
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002334964235"))
